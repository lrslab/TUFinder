...
if __name__ == '__main__':
    ...
    parser.add_argument("--bam", default='genomic.bam',
                        help="bam file")
    parser.add_argument("--bed", default="gene.bed", help="bed file")
    ...
    parser.add_argument("--output", default='TU_result', help='result path')
